![Header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,12,19&height=200&section=header&text=Said%20Mrini&fontSize=50&fontColor=fff&animation=fadeIn)

<div align="center">

### IT & Web Developer | Balaguer, España

Hi, I'm Said! A passionate web application developer who thrives at the intersection of code and creativity. With expertise in PHP, Laravel, React, and Node.js, I leverage my background in 3D modeling and electronics to deliver innovative solutions that blend functionality with design.
